        ...
        <div className="main">
          ...
          <div className="form">
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-8">
                <select type="text" categoryName="form-control " style={{width:"360px"}} placeholder="Select City" name="city" value={this.state.city} onChange={this.onChange}>
            ...
            <div className="mb-3">
              <button className="btn4 btn-success float-end" onClick={this.editAddress}>
                Update Address
            </button>
              <br></br>
            </div>
