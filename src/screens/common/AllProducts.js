...
class ProductCategoryScreen extends Component {
  ...
  reloadProductsList() {
    ApiCustomerService.fetchAllProducts()
      .then((res) => {
            ...
            <div className="container">
              <div className="row row-center">
                {this.state.products.map(product =>
                  <div className="product col-md-3" style={{ backgroundColor: "lightgoldenrodyellow",width:"297px"}} key={product.id}>
                    <div className="title">
